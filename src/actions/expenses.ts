...
export const startAddExpense = (expenseData: {description: string, note: string, amount: number, createdAt: number}) => {

  //typeof dispatch là Dispatch import của Redux (ko phải import của react)
